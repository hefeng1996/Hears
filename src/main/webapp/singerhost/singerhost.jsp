                                            ...
                                            <div class="modal-content"style="min-height: 380px;">
                                                ...
                                                <div class="modal-body colectsonglist">
                                                    ...
                                                    <ul class="collect_ul" style="min-height: 56px;">
                                                        ...
                                                        <li class="collect_li" onclick="jingjing(${songlist.id}) ">
                                                            ...
                                                            <%--<input type="hidden" name="id" id="id" value="${songlist.id}">--%>
                                                            <input type="hidden" name="colsongid" id="colsongid" value="">
                                                            <input type="hidden" name="colsonglistid" id="colsonglistid" value="">
...
//    收藏歌曲提交
    function jingjing(id) {
        ...
        <%--document.getElementById("collect_form").action = "<%=basePath%>songlist/colsonglist.action"+info;--%>
