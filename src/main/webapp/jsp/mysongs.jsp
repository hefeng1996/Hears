...
<div class="container" style="height: 70px; width: 100%;margin: 0;padding: 0;position: fixed;">
    <nav class="nav menu menu--miranda" style="background-color:#000000;height: 70px;" >
        <img href="#"  id="logo" src="<%=basePath%>images/logo.png">
        <ul class="menu__list" id="ul">
            ...
            <li class="menu__item menu__item--current" style="margin-left: 1px"><a href="#" class="menu__link" onclick="window.location = '<%= basePath%>user/mysongs.action'">我的音乐</a></li>
            ...
            <div class="search d7">
                <form action="<%=basePath%>search/searchall.action" method="get">
                    ...
                    <button type="submit"><img style="margin-left: -10px" src="<%= basePath%>main/img/1.jpg"/></button>
                </form>
            </div>
