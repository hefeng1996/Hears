...
<div class="container" style="height: 70px; width: 100%;margin: 0;padding: 0">
    <nav class="nav menu menu--miranda" style="background-color:#000000;height: 70px;" >
        <img href="#"  id="logo" src="<%=basePath%>images/logo.png"></img>
        <ul class="menu__list" id="ul">
            ...
            <li class="menu__item" style="margin-left: 1px"><a href="#" class="menu__link" onclick="window.location='<%= basePath%>/user/personalInformation.action'">返回个人中心</a></li>
