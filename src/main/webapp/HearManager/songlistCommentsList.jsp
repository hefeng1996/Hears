...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            <input type="text" name="username"  placeholder="请输入歌单名" autocomplete="off" class="layui-input">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>致我们单纯的小美好</td>
            <td>kate</td>
            <td>遇见你的时候所有星星都落到我的头上</td>
            <td>2018-06-23 08:46:28</td>
            <td>无</td>
            <td class="td-manage">
                <a title="删除" onclick="member_del(this,'要删除的id')" href="javascript:;">
                    <i class="layui-icon">&#xe640;</i>
