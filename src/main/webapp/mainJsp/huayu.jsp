...
<div style="height:1000px; background-color: white; border: 1px solid #cccccc;width: 980px; margin:0 auto;">
   <div style="margin: 40px; width: 900px;">
        <p style="float: left; font-size: xx-large">${tag}</p>
       <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal" style="margin: 10px;height: 32px">
       ...
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="img1" id="tuijian1" style="margin-top: 40px;  width: 100%;">
            <c:forEach items="${chinaSonglist}" var="china">
                <a style="float: left; color: black;height: 205px;width: 180px;margin: 0 20px;" href="<%= basePath%>songlist/songlist.action?id=${china.id}" >
