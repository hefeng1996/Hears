...
<div class="container">
    <div style="width: 1000px;margin-left:40px;border: 1px solid #e0e0e0;background-color: white">
                ...
                <table id="playcord" class="table-hover">
                    <c:forEach items="${playrecords20}" var="record20" varStatus="s">
                        <tr  style="height: 40px">
                            ...
                            <jsp:setProperty name="dateValue" property="time" value="${record20.playtime}"/>
                ...
                <table hidden id="playcordAll"  class="table-hover">
                    <c:forEach items="${playrecordsAll}" var="recordsAll" varStatus="s">
                        <tr style="height: 40px">
                            ...
                            <jsp:setProperty name="dateValue1" property="time" value="${recordsAll.playtime}"/>
